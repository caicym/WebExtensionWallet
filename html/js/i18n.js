...
var i18n = function () {
    var table = {
        en: {
            ...
            "gas-price": "Gas Price",
            "gas-used": "Gas Used",
            // "header/check": "Check-TX", //"Check TX Status",
            "header/check": "Refresh", //"Check TX Status",
            "header/close": "Close", //"Check TX Status",
            "header/refresh_button": "Check-TX", //"Check TX Status",
            "header/check_text": "Check Transaction", //"Check TX Status",
            "header/contract": "Contract",
            "header/new-wallet": "New-Wallet", //"Create New Wallet"
            "header/send": "Send-TX",
        ...
        zh: {
            ...
            "gas-used": "Gas 消耗",
            "header/check": "交易状态",
            "header/close": "关闭", //"Check TX Status",
            "header/check_text": "交易状态", //"Check TX Status",
            "header/contract": "合约",
            ...
            "send-nas/button/reject": "取消交易",
            "send-nas/button/rejectAll": "取消所有交易",
